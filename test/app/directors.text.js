...
describe("/api/directors tests",()=>{
    ...
    describe("/Get directors",()=>{
        it("tüm directorlar listelenmeli",(done)=>{
    ...
    describe("POST director",()=>{
        it("api/director e director kaydetmeli",(done)=>{
            const director={
                name:"yılmaz2",
                surname:"aslancı2",
                bio:"inegöllü"
            ...
            chai.request(server)
                ...
                .end((err,res)=>{
                    ...
                    res.body.should.have.property("name"); // dönen ojenin propertyleri arasında title olmalı ....
                    res.body.should.have.property("surname"); // dönen ojenin propertyleri arasında title olmalı ....
                    res.body.should.have.property("bio"); // dönen ojenin propertyleri arasında title olmalı ....
